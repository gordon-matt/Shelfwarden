        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                ...
                WHERE "TimelineDateId" IN (
                    SELECT "Id" FROM "app"."TimelineDates" WHERE BTRIM("Date") = ''
                );
                """);

            migrationBuilder.Sql(
                """
                DELETE FROM "app"."TimelineDates" WHERE BTRIM("Date") = '';
                """);
