    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CoverImagePath = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                FileLastModified = table.Column<DateTime>(type: "TEXT", nullable: true),
                LastScannedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                ShelfId = table.Column<int>(type: "INTEGER", nullable: false),
                SeriesId = table.Column<int>(type: "INTEGER", nullable: true),
                NumberInSeries = table.Column<double>(type: "REAL", precision: 10, scale: 2, nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                VoiceName = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                ...
                OutputSizeBytes = table.Column<long>(type: "INTEGER", nullable: true),
                ...
                HangfireJobId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Location = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
